...
public class AccountsDatabase {
    ...
    {
        Account accounts1 = new Account("Nantha" ,98712  ,"9999999999", "159/10,Jayam Nagar,Theni,Tamil Nadu", 12345,500.0f,false );
        ...
        Account accounts5 = new Account("Ismail",55555,"9876987698","Chennai", 7777 , 200000.0f , false);
