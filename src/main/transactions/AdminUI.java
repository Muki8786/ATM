...
public class AdminUI implements IAdminUI {
    ...
    public int getDepositChoice()
    {
        ...
        while(true)
        {
            ...
            System.out.println("\t\tPress 2 to Empty cash dispenser and fill the cash dispenser");
            System.out.println("\t\tPress 0 to exit");
    ...
    {
        System.out.println("\nThe amount from the deposit slot is " + amount);
    }
    ...
    public void printCashDispenserSuccess(boolean status)
    {
        ...
        {
            System.out.println("\n\t\tCash dispenser filling failed due to higher amount or denomination count mismatch");
            System.out.println("\n\t\tPlease take the cash which you have taken from Deposit slot");
        }
    }
}
